...
class OrderStatusUpdateEndpointTest extends Action
{
    ...
    public function execute()
    {
        ...
        $json = '{"id":"2c1021b9-140c-4797-8f90-a770ec72eb24","order":{"storeData":{"orderId":"39307"}},"storeData":{"lineNumber":1,"productId":"74134"},"projectId":"e1632d79-2ed8-4434-9a12-e0c9f8664d6b","status":{"value":"AvailableForDownload","effectiveDateUtc":"2018-04-02T13:15:31.9013935Z"}}';
        ...
        if (!empty($obj)) {
            ...
            if (isset($obj['status']) && $obj['status']['value'] == 'AvailableForDownload') {
                ...
                if ($orderId) {
                    ...
                    if ($uploadfolder == '') {
                        $uploadfolder = $product->getMediaclipProductSupplier();
                    }
                    ...
                    if($uploadfolder == 'pwinty'){
                        ...
                        if (!in_array(0, $status)) { // check if all items are downloaded
                            ...
                            foreach ($projectDetails as $value) { 
                                ...
                                $filesUploadPath = '/home/canvaspr/inkifi.com/html/mediaclip_orders/'.$orderDirDate.'/pwinty/'.$orderIncrementId.'/'.$orderItemID.'/'.$mediaClipOrdersData['product_label'];
                        ...
                        foreach ($mediaclipOrderDetails->lines as $lines){
                            ...
                            if ($ftp_json == 1) {
                                ...
                                $filesUploadPath = '/home/canvaspr/inkifi.com/html/mediaclip_orders/'.$orderDirDate.'/ascendia/'.$orderIncrementId.'/'.$orderItemID.'/'.$mediaClipOrdersData['product_label'];
                                ...
                                foreach ($linesDetails->files as $key => $fileDetails) { 
                                    ...
                                    $array1['components'] = array(array('code' => 'prints-set-01','fetch' => true,'path' =>$fileDetails->url ));
                                    $array1['quantity'] = 1;
